...
export const DISCLAIMER_SHORT =
  'Always verify current label directions and local agronomic advice before application.';
    ...
    <div className="mt-4 rounded-lg border border-slate-700/30 bg-slate-800/30 px-4 py-3">
      <div className="flex items-start gap-2">
        ...
        <div>
          ...
          <p className="text-[10px] text-slate-600 leading-relaxed mt-1.5 font-medium">{DISCLAIMER_SHORT}</p>
        </div>
      </div>
    </div>
  );
